...
for i in range(0, 4):
    pcp.prettyColors(seasonal_avgs[i], title = 'title', cmap = 'BrBG', save = ('/Users/dfencekey/Desktop/Coding/Capstone/Capstone-PDO-Precip-Data-Analysis/Plots/Season' + str(i) + 'AvgZscores.png'))