...
for i in range(0, 4):
    pcp.prettyColors(seasonal_avgs[i], title = 'Average ' + szn_names[i] + ' Z-Scores During PCs', cmap = 'BrBG', save = ('/Users/dfencekey/Desktop/Coding/Capstone/Capstone-PDO-Precip-Data-Analysis/Plots/' + szn_names[i] + 'AvgZscores.png'), vmin = -0.6, vmax = 0.6, clabel = 'Z-Scores')